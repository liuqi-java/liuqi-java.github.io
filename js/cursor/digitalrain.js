...
(function() {
    ...
    $packages["main"] = (function() {
            ...
            $global.addEventListener($externalize("load", $String), $externalize((function $b() {
                ...
                /* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; _r = $f._r; _r$1 = $f._r$1; _tuple = $f._tuple; _tuple$1 = $f._tuple$1; cover = $f.cover; err = $f.err; rain1 = $f.rain1; rain2 = $f.rain2; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
                    ...
                    /* if (!($interfaceIsEqual(err, $ifaceNil))) { */ case 1:
                        ...
                        $s = -1; return;
                    /* } */ case 2:
                        var digitalraindiv = document.getElementById('digitalrain');
                        ...
                        // cover.style.position = $externalize("relative", $String);
                        
                        // $global.document.body.appendChild(cover);
                        digitalraindiv.appendChild(cover);
        ...
        DigitalRain.ptr.prototype.layout = function() {
            ...
            r.canvas.width = digitalraindiv.offsetWidth;
            r.canvas.height = digitalraindiv.offsetHeight;
            ...
            // r.canvas.style.position = $externalize("relative", $String);

            // r.parent.appendChild(r.canvas);
            //添加到div
            digitalraindiv.appendChild(r.canvas);
        ...
        NewGlyphCanvas = function(color) {
            ...
            //添加到div
            // digitalraindiv.appendChild(glyphCanvas.jso);
